        ...
        if red_finished and blue_finished:
            ...
            for ai, aj in delta:
                ...
                if 0 <= blue_ni < N and 0 <= blue_nj < M:
                    if not v_b[blue_ni][blue_nj] and (blue_ni, blue_nj) != (red_i, red_j):
            ...
            for bi, bj in delta:
                ...
                if 0 <= red_ni < N and 0 <= red_nj < M:
                    if not v_r[red_ni][red_nj] and (red_ni, red_nj) != (blue_i, blue_j):
                        ...
                        for di, dj in delta:
                            ...
                            if 0 <= blue_ni < N and 0 <= blue_nj < M:
                                if not v_b[blue_ni][blue_nj]:
                                    if (blue_ni, blue_nj) != (red_ni, red_nj):
                                        if not ((blue_ni, blue_nj) == (red_i, red_j) and (red_ni, red_nj) == (blue_i, blue_j)):
                                            new_v_r = deepcopy(v_r)
                                            new_v_r[red_ni][red_nj] = 1
                                            new_v_b = deepcopy(v_b)
                                            new_v_b[blue_ni][blue_nj] = 1
